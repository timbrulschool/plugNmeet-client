            ...
            <li key={user.id} className="flex items-center gap-2 text-sm">
              ...
              {!user.joined && (
                <button
                  ...
                  className="primary-button ml-auto h-6 px-3 cursor-pointer text-xs font-semibold bg-Blue hover:bg-white border border-[#0088CC] rounded text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow"
                >
