...
const SharedNotePadIcon = () => {
  ...
  return (
    shouldRenderIcon && (
      <div
        className={`sharedNotePad hidden md:block relative footer-icon cursor-pointer w-11 3xl:w-[52px] h-11 3xl:h-[52px] rounded 3xl:rounded border-[3px] 3xl:border-4 ${
