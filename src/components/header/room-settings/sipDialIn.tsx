      ...
      <form method="POST" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex justify-end mt-4">
          <button
            ...
            disabled={isLoading}
            className="primary-button h-8 px-5 flex items-center justify-center text-sm font-semibold bg-Blue hover:bg-white border border-[#0088CC] rounded text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow cursor-pointer disabled:opacity-50"
          >
            {isLoading ? (
              <LoadingIcon
      ...
      <>
        ...
        <div className="flex justify-end mt-10">
          <button
            ...
            className="primary-button h-8 px-5 flex items-center justify-center text-sm font-semibold bg-Blue hover:bg-white border border-[#0088CC] rounded text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow cursor-pointer"
          >
