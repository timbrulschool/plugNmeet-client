...
const RemoveParticipantAlertModal = ({
  ...
  const renderButtons = () => {
    return (
      <Fragment>
        <button
          className="h-10 px-5 w-32 flex items-center justify-center rounded text-sm 3xl:text-base font-medium 3xl:font-semibold text-white bg-Red-400 border border-Red-600 transition-all duration-300 hover:bg-Red-600 shadow-button-shadow cursor-pointer"
        ...
        <button
          type="button"
          className="primary-button h-10 px-5 w-32 flex items-center justify-center text-sm 3xl:text-base font-semibold bg-Blue hover:bg-white border border-[#0088CC] rounded text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow cursor-pointer ml-4"
